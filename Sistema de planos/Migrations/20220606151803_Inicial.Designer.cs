...
namespace Sistema_de_planos.Migrations
{
    ...
    [Migration("20220606151803_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstadoHistorico", b =>
                {
                    ...
                    b.HasKey("EstadosId", "HistoricosId");

                    b.HasIndex("HistoricosId");

                    b.ToTable("EstadoHistorico");
                });
            ...
            modelBuilder.Entity("EstadoHistorico", b =>
                {
                    b.HasOne("Sistema_de_planos.Dominio.Entidades.Estado", null)
                        .WithMany()
                        .HasForeignKey("EstadosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sistema_de_planos.Dominio.Entidades.Historico", null)
                        .WithMany()
